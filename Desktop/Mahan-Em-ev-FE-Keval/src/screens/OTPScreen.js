import { Image, StyleSheet, Text, TextInput, View, Alert, ToastAndroid } from "react-native";
    ...
    return (
        <View style={styles.container}>
            <View style={styles.imageBox}>
                <Image style={styles.img} source={require('../assets/otp.png')} resizeMode="contain" />
            </View>
            <View style={styles.lable}>
                ...
                <View style={styles.otpView}>
                    <TextInput
                        ref={et1}
                        style={[styles.inputView, !isValid ? { borderColor: '#EA0000' } : { borderColor: '#979797' }]}
                ...
                <View style={styles.resendTxt}>
                    {!isValid && <Text style={styles.text3} >Please enter a valid OTP</Text>}
                    {isValid && <Text style={styles.text1} >Didn't you receive the OTP? </Text>}
