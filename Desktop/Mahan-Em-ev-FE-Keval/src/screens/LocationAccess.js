    ...
    return(
        <View style={styles.container}>
            <View style={styles.innerContainer}>
                ...
                <Text style={styles.text}>To ensure a seamless and effective experience, allow
                us to access your location</Text>
            </View>
            <CustomButton title={'Allow location Access'} onPress={gotoHomepaage}/>
            <View style={styles.btn}>
                <YellowOutlineButton title={'Maybe  Later'} onPress={gotoHomepaage}/>
            </View>
        </View>
    )
}
