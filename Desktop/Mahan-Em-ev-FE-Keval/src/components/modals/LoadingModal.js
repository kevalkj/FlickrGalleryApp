 ...
 <>
    ...
    visible={showModal}>
     <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.profileIconContainer} onPress={() => {console.log("open drawer") 
      ...
      <View style={styles.loadingContainer}>
        ...
        <TouchableOpacity style={styles.button} onPress={cancleRide}>
          <Text style={styles.text}>Cancel</Text>
        </TouchableOpacity>
      </View>
    </View>
 </Modal>
 <CancelRideModal showModal={showCancelModal}  closeModal={closeCancelModal}/>
 </>
 );
};
