      ...
      <View style={styles.centeredView}>
        ...
        <View style={styles.modalView}>
          ...
          <Text style={styles.description}>
            Your vehicle has not moved for the past 10 minutes. If there is any problem, please contact us immediately for assistance.
          </Text>
          <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.buttonY} onPress={()=>{navigation.goBack()}}>
              <Text style={styles.textStyleY}>Yes</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.buttonN} onPress={()=>{navigation.goBack()}}>
...
const App = () => {
  ...
  useEffect(() => {
    ...
    }, 60); // later put 10 minutes in milliseconds
